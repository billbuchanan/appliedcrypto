...
What is the subject of the certificate?

Who is the issuer on the certificate?

### A.4	

Google moved in July 2018 to mark sites as being insecure if they did not have a match between their digital certificate and the site. First, open a browser and see if you can access hmizoapex.bank.in (you can try both https and http for the connection). 
...
### A.5	
For the certificates in A.2, for Example 2 to Example 6. Complete the following table:
...
There are two OID numbers related to the public key encryption method and the signature method. Use this page [here](https://oidref.com/) to identify them.
