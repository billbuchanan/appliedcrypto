...
### B.3 
Now we will implement a key exchange in OpenSSL with ECDH. Implement the following, and check that the derived keys are the same. First generate Alice's private and public keys:
